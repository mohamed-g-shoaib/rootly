      ...
      <div className="px-2 md:px-3 pt-2 md:pt-3 pb-1">
        <div className="flex items-center justify-between mb-2 md:mb-3">
          ...
          <div className="flex items-center gap-2">
            ...
            >
              <Funnel className="text-sm text-muted-foreground" size={16} />
            </button>
          </div>
        </div>
        ...
        <div className="h-full pt-0 pb-24 md:pb-32 flex flex-col justify-end gap-1.5 md:gap-2">
          {items.slice(1).map((item, idx) => (
            <motion.div
              ...
              className="bg-background border border-border p-2 md:p-3 transform-gpu"
            >
          ...
          {showIncoming && (
            <motion.div
              ...
              className="bg-secondary border border-border p-2 md:p-3 transform-gpu absolute bottom-[48px] md:bottom-[68px] left-2 md:left-3 right-2 md:right-3 z-50"
            >
              <div className="flex items-start gap-1.5 md:gap-2">
                <span className="inline-flex w-5 h-5 md:w-6 md:h-6 items-center justify-center bg-secondary border border-border flex-shrink-0">
                  <Image
