...
Use it when the user needs to quickly copy generated or read-only content. Common examples are "Copy invite link," "Copy token," "Copy command," "Copy code," or "Copy support email."
